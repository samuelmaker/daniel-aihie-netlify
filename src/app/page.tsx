      ...
      >
        <div className="h-full">
          ...
          <div className="h-[90%] flex flex-col justify-center items-center relative">
            <h3 className="mb-1 sm:mb-3 inline-block px-4 md:px-8 md:py-2 bg-white border-[4px] md:border-[6px] border-black rounded-md md:rounded-[10px] font-bold text-base sm:text-2xl lg:text-4xl text-black uppercase">
              Daniel Aihie
            </h3>
            ...
            <div className="absolute left-[-1%] top-[38%] sm:left-[5%] sm:top-[37%] md:top-[30%] lg:left-[5%] lg:top-[20%]">
              <Link
                href="/creative"
                className="inline-block px-2 md:px-8 md:py-2 bg-white border-[4px] md:border-[6px] border-black rounded-[10px] font-bold text-base sm:text-2xl lg:text-4xl text-black uppercase"
              >
                Creative
              </Link>
            </div>
